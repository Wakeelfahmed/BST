...
int main() {
    // Run test cases
    bool testResult1 = Tester::testInsertion();
    bool testResult2 = Tester::testInsertionEdgeCase();
    bool testResult3 = Tester::testInsertionErrorCase();
    ...
    // Output test results
    cout << "Test 1: Insertion (Normal Case) - " << (testResult1 ? "Passed" : "Failed") << endl;
    cout << "Test 2: Insertion (Edge Case) - " << (testResult2 ? "Passed" : "Failed") << endl;
    cout << "Test 3: Insertion (Error Case) - " << (testResult3 ? "Passed" : "Failed") << endl;
    cout << "Test 4: Balancing After Insertions - " << (testResult4 ? "Passed" : "Failed") << endl;
    cout << "Test 5: BST Property After Insertions - " << (testResult5 ? "Passed" : "Failed") << endl;
    cout << "Test 6: Removal (Normal Case) - " << (testResult6 ? "Passed" : "Failed") << endl;
    cout << "Test 7: Removal (Edge Case) - " << (testResult7 ? "Passed" : "Failed") << endl;
    cout << "Test 8: Balancing After Removals - " << (testResult8 ? "Passed" : "Failed") << endl;
    cout << "Test 9: BST Property After Removals - " << (testResult9 ? "Passed" : "Failed") << endl;
    cout << "Test 10: Remove Deorbited - " << (testResult10 ? "Passed" : "Failed") << endl;
    cout << "Test 11: Count Satellites - " << (testResult11 ? "Passed" : "Failed") << endl;
    cout << "Test 12: Find Satellite (Normal Case) - " << (testResult12 ? "Passed" : "Failed") << endl;
    cout << "Test 13: Find Satellite (Error Case) - " << (testResult13 ? "Passed" : "Failed") << endl;
    cout << "Test 14: Assignment Operator (Normal Case) - " << (testResult14 ? "Passed" : "Failed") << endl;
    cout << "Test 15: Assignment Operator (Error Case) - " << (testResult15 ? "Passed" : "Failed") << endl;
